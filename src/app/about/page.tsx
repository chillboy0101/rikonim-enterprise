          ...
          <div className="grid gap-10 md:grid-cols-12 md:items-start">
            ...
            <div className="md:col-span-12">
              <div className="grid gap-6 md:grid-cols-12">
                ...
                <div className="overflow-hidden rounded-3xl border border-brand-ink/10 bg-brand-mist shadow-[0_18px_50px_rgba(11,18,32,0.10)] md:col-span-6">
                  <div className="aspect-[16/10] w-full">
                    <img
                ...
                <div className="overflow-hidden rounded-3xl border border-brand-ink/10 bg-brand-mist shadow-[0_18px_50px_rgba(11,18,32,0.10)] md:col-span-12">
